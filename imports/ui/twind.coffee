...
options =
  ...
  preflight: (preflight, {theme}) -> {
    ...
    ':root':
      ...
      button: apply"rounded bg-secondary-400 text-white px-4 py-1 hover:bg-opacity-50"
      'button.primary': apply"bg-primary-500 text-white"
      'button.danger': apply"bg-danger-500 text-white"
      'button.ok': apply"bg-ok-500 text-white"
      'button.warn': apply"bg-warning-500 text-white"
      'button.icon': apply"w-8 h-8 p-0 rounded-full"
      '.spaces-resize-handle': apply"bg-secondary-100 hover:bg-secondary-200 cursor-move"
      ...
      '.Toastify__toast button': apply"w-8 bg-transparent! text-white"
      '.Toastify__toast--default': apply"bg-secondary-500 text-black"
      '.Toastify__toast--info': apply"bg-primary-500 text-white"
      '.Toastify__toast--success': apply"bg-ok-500 text-white"
      '.Toastify__toast--warning': apply"bg-warning-500 text-white"
